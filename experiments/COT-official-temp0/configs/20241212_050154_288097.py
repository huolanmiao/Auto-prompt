    ...
    dict(abbr='gsm8k',
        ...
        infer_cfg=dict(
            ...
            prompt_template=dict(
                template=dict(
                    round=[
                        dict(prompt='As an expert problem solver solve step by step the following mathematical questions. Question: {question}\nAnswer:',
                            role='HUMAN'),
                        ]),
...
work_dir='outputs/default/20241212_050154'